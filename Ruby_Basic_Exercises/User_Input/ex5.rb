...
puts "How many lines should be printed? Number must be at least 3."
...
Like the previous exercise, our solution uses the soon-to-be-familiar pattern of looping to obtain a valid input. 
In this case, we use #to_i to convert inputs to Integer values, and only allow inputs of at least 3.
