...
Our goal here is to run the loop only if process_the_loop evaluates as true. We can use an if/else statement to accomplish this task.
...
Then all we need to do is place puts "The loop wasn't processed!" in the else clause. This will print if process_the_loop evaluates as false.
