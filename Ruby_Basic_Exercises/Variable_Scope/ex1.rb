...
# solution a is not modified by the method, so the answer is 7. The output of myvalue(a) is 17 though.
# Discussion
...
#That is, += sets the variable to point to a different object. Since line 4 binds b to a new object, the object pointed to by a remains unchanged.
