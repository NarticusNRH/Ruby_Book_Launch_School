...
It's typically used to iterate over a collection. 
In this case, we use it to iterate over the range 1..100, therefore, the i variable represents the current iteration number. 
This makes it easy to count from 1 to 100 by outputting the value of i.

For this exercise, we'd like to only output the odd numbers. We can do this by adding an if statement to #puts.
